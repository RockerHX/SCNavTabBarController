#
#  Be sure to run `pod spec lint SCNavTabBarController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/gevin/SCNavTabBarController.git", :commit => "226b1f3f28411f643ebdb1bcadb63a49d4809f18" }
